...
import com.duzi.chartandcalendar.R;
import com.duzi.chartandcalendar.utils.DateFormats;
import com.duzi.chartandcalendar.utils.DateUtils;
import com.duzi.chartandcalendar.utils.StyledResources;
...
import static com.duzi.chartandcalendar.utils.InterfaceUtils.dpToPixels;


public class ScoreChart extends ScrollableChart {

    /**
     * XFERMODE란 트랜스퍼모드의 줄임말로
     * ` PorterDuffXfermode ` 클래스는 알파 합성 규칙에 따른 합성을 한다?
     * 참고 : https://probitanima11.github.io/posts/16
     */
